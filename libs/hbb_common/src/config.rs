...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("ONEDESK".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["help.ONEDESK.es"];
pub const PUBLIC_RS_PUB_KEY: &str = "NGfnDPgTbVvqW50KqowmxyaLwwiAIsU472qPKuXMZbk=";
